...
DEFINITOINS = {
    ...
    'тапахед': '(Десктоп) подсказка в виде слова, которое вы предположительно вводите/хотите ввести, отображается в поле ввода серыми буквами после ввода первой буквы.
тачи, подсказка в виде слов на серых плашках, которые вы предположительно вводите/хотите ввести.',
...
def start_command_handler(message: types.Message):
    ...
    bot.send_message(
        ...
        text='Привет! Я расшифрую тебе термины асессоров ЯНГа 🤓 Используй меня!\nВведи интересующий термин, например, тапахед', # текст сообщения
    )
