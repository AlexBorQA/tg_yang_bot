...
'тумблер': 'Переключатель.',
     'баг2': 'некорректная работа программы, вызванная ошибкой в программном коде или дизайне продукта',
    ...
    'регресс2': 'Проверка на наличие багов, вызванных изменениями в приложении',
}
